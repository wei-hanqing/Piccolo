...
namespace Piccolo
{
    ...
    void VignettePass::setupPipelines()
    {
        ...
        VkShaderModule vert_shader_module = VulkanUtil::createShaderModule(m_vulkan_rhi->m_device, VIGNETTE_VERT);
        VkShaderModule frag_shader_module = VulkanUtil::createShaderModule(m_vulkan_rhi->m_device, VIGNETTE_FRAG);
    ...
    void VignettePass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void VignettePass::draw()
    {
        if (m_vulkan_rhi->isDebugLabelEnabled())
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "Vignette", {1.0f, 1.0f, 1.0f, 1.0f}};
